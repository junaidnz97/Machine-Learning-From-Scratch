...
def update_code_book_vector(features,ytrain,c_book_vector,c_book_output,max_epochs):
	alpha=0.3
...
max_epochs=20
c_book_vector=update_code_book_vector(xtrain,ytrain,c_book_vector,c_book_output,max_epochs)
